<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" v-show="showSearch">
      <el-form-item label="部门名称" prop="deptName">
       ...
       <el-form-item label="部门分类" prop="deptType">
        <el-select v-model="queryParams.deptType" placeholder="部门分类" clearable size="small">
          <el-option
    ...
    >
      ...
      <el-table-column prop="deptCode" label="部门编码" width="100"></el-table-column>
      <el-table-column prop="deptType" label="部门分类" width="200" align="center" >
