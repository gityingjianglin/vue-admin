  ...
  <div class="app-container">
    ...
    <el-table ref="tables" v-loading="loading" :data="list" @selection-change="handleSelectionChange" :default-sort="defaultSort" @sort-change="handleSortChange">
      ...
      <el-table-column label="日志编号" align="center" prop="operId" />
       <el-table-column label="应用名称"  prop="appName" :show-overflow-tooltip="true" width="140">
      </el-table-column>
      ...
      <el-table-column label="操作日期" align="center" prop="operTime" sortable="custom" :sort-orders="['descending', 'ascending']"  width="150">
        <template slot-scope="scope">
...
<script>
import { list, delOperlog, cleanOperlog, getAppInfo } from "@/api/system/operlog";
