  ...
  <div class="navbar">
    ...
    <div class="right-menu">
      ...
      <el-dropdown class="avatar-container right-menu-item hover-effect" trigger="click">
        <div class="avatar-wrapper h-view align-center">
          <img src="@/assets/logo/logo.svg" class="user-avatar" alt="logo加载失败">
          {{name}}
    ...
    async logout() {
      this.$confirm('确定注销并退出系统吗？', '提示', {
        ...
        this.$store.dispatch('LogOut').then(() => {
          outLogin()
          // location.href = '/index';
          /* console.log(this.$store.getters.appClientId, 'this.$store.getters.clientId');
